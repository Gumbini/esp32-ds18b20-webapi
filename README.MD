...
- Set up your WiFi credentials:
  - Create a new *encData.hpp* header using my project [Credentials Obfuscating Tool](https://github.com/Gumbini/credentials-obfuscating-tool) and place it in the *include* directory
